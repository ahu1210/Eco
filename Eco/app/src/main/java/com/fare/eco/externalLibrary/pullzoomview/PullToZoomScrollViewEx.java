package com.fare.eco.externalLibrary.pullzoomview;
...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> implements AbsListView.OnScrollListener {
    ...
    protected void onScrollChanged(int x, int y, int oldx, int oldy) {
        ...
        if (scrollViewListener != null) {
            scrollViewListener.scrollChanged(x, y, oldx, oldy);
        }
    }
