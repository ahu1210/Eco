...
/******************************************************************
 * 文件名称: CookieManager.java
 * 作          者: fushangbin
 * 创建时间: 2011-2-26 上午10:52:20
 * 文件描述: cookie 管理类
 ******************************************************************/
...
//                ret.append(' ');
    ...
    /****************************************************************************************
     * 函数名称：removeSessionCookie
     * 函数描述：清空所有session cookie
     * 输入参数：
     * 输出参数：
     * 返回    值：void
     * 备         注：
     ...
     * 输入参数：@param host
     * 输入参数：@param path
     * 输入参数：@param cookieString
     * 输入参数：@return
     * 输出参数：
     * 返回    值：ArrayList<Cookie>
     * 备         注：
     ****************************************************************************************/
