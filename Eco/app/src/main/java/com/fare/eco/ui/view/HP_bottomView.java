...
public class HP_bottomView extends LinearLayout implements OnClickListener {
	...
	public HP_bottomView(Context context) {
		this(context, null);
	}

	public HP_bottomView(Context context, AttributeSet attrs) {
	 ...
	 * @param defStyle
	 */
	public HP_bottomView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		inflate(context, R.layout.hp_bottom_tab, this);
