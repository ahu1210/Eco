...
import com.fare.eco.externalLibrary.volley.toolbox.HurlStack;
...
public class MultiPartStack extends HurlStack {
	...
	private String boundary = "---------------------------7da2137580612";    // 数据分隔符  
	...
	public HttpResponse performMultiPartRequest(Request<?> request,
		...
		httpRequest.setHeader("Content-Type", "multipart/form-data" + "; boundary=" + boundary); // TODO
	...
	private static void setMultiPartBody(
		...
		Map<String, File> fileUpload = ((MultiPart) request)
				.getFileUploads();
		...
		Map<String, String> stringUpload = ((MultiPart) request)
				.getStringUploads();
