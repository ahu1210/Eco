 ...
 *******************************************************************************/
package com.fare.eco.externalLibrary.imageload.core;
...
import com.fare.eco.externalLibrary.imageload.core.assist.FailReason;
import com.fare.eco.externalLibrary.imageload.core.assist.FailReason.FailType;
import com.fare.eco.externalLibrary.imageload.core.assist.ImageScaleType;
import com.fare.eco.externalLibrary.imageload.core.assist.ImageSize;
import com.fare.eco.externalLibrary.imageload.core.assist.LoadedFrom;
import com.fare.eco.externalLibrary.imageload.core.assist.ViewScaleType;
import com.fare.eco.externalLibrary.imageload.core.decode.ImageDecoder;
import com.fare.eco.externalLibrary.imageload.core.decode.ImageDecodingInfo;
import com.fare.eco.externalLibrary.imageload.core.download.ImageDownloader;
import com.fare.eco.externalLibrary.imageload.core.download.ImageDownloader.Scheme;
import com.fare.eco.externalLibrary.imageload.core.imageaware.ImageAware;
import com.fare.eco.externalLibrary.imageload.core.listener.ImageLoadingListener;
import com.fare.eco.externalLibrary.imageload.core.listener.ImageLoadingProgressListener;
import com.fare.eco.externalLibrary.imageload.utils.IoUtils;
import com.fare.eco.externalLibrary.imageload.utils.L;
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
	...
	public void run() {
		...
		try {
			...
			bmp = configuration.memoryCache.get(memoryCacheKey); // 内存获取
			if (bmp == null || bmp.isRecycled()) {
				bmp = tryLoadBitmap(); // 磁盘和网络
	...
	private Bitmap tryLoadBitmap() throws TaskCancelledException {
		...
		try {
			...
			if (bitmap == null || bitmap.getWidth() <= 0 || bitmap.getHeight() <= 0) {
				...
				if (options.isCacheOnDisk() && tryCacheImageOnDisk()) { // 下载图片
				...
				checkTaskNotActual();
				bitmap = decodeImage(imageUriForDecoding); // 读取保存在sd卡的图片
