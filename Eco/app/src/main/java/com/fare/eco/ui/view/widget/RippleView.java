package com.fare.eco.ui.view.widget;
...
public class RippleView extends RelativeLayout {
	...
	private int WIDTH;
	private int HEIGHT;
	private int FRAME_RATE = 120; // 发散速度
	private int DURATION = 400;
	private int PAINT_ALPHA = 90; // 水波透明度,默认90(0-255)
	private int zoomDuration;
	private int rippleColor; // 水波效果,默认白色
	...
	public void draw(Canvas canvas) {
		...
		if (animationRunning) {
			...
			paint.setColor(0xffff4444); // Color.parseColor("#ffff4444")
